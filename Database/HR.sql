...
;
CREATE INDEX "TRAINING"."EMP_JOB_IX"
ON "TRAINING"."EMPLOYEES" ("JOB_ID" ASC)
;
CREATE INDEX "TRAINING"."EMP_MANAGER_IX"
ON "TRAINING"."EMPLOYEES" ("MANAGER_ID" ASC)
;
CREATE INDEX "TRAINING"."EMP_NAME_IX"
...
CREATE OR REPLACE TRIGGER "TRAINING"."UPDATE_JOB_HISTORY" AFTER UPDATE OF "DEPARTMENT_ID","JOB_ID" ON "TRAINING"."EMPLOYEES" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW
BEGIN
...
;
CREATE INDEX "TRAINING"."JHIST_EMPLOYEE_IX"
ON "TRAINING"."JOB_HISTORY" ("EMPLOYEE_ID" ASC)
;
CREATE INDEX "TRAINING"."JHIST_JOB_IX"
...
;
CREATE INDEX "TRAINING"."LOC_COUNTRY_IX"
ON "TRAINING"."LOCATIONS" ("COUNTRY_ID" ASC)
;
CREATE INDEX "TRAINING"."LOC_STATE_PROVINCE_IX"
